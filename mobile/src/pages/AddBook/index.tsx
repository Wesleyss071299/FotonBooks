...
// Styled Components
import { Container, Label, ChooseImageBox, InputBox, TitleBox } from './styles'
// Redux
        ...
        <>
            ...
            {isOpen && 
                <ModalView 
                    isOpen={isOpen} 
                    setIsOpen={setIsOpen} 
                    title={isSuccess? 'Cadastrado com Sucesso' : 'Por favor, Preencha todos os campos'}>
                    {
                        isSuccess ? <Ionicons name="checkmark-circle-sharp" size={80} color="green" onPress={() => setIsOpen(false)} />:
